...
// Server lists the categories service endpoint HTTP handlers.
type Server struct {
	Mounts         []*MountPoint
...
// New instantiates HTTP handlers for all the categories service endpoints
...
func (s *Server) Service() string { return "categories" }
...
// Mount configures the mux to serve the categories endpoints.
...
// and calls the "categories" service "create_category" endpoint.
func NewCreateCategoryHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "categories")
